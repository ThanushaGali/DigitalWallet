...
const mockReceipts: Receipt[] = [
  {
    ...
    totalAmount: 75.5,
    itemizedList: [
      { item: 'Organic Avocados', price: 5.99 },
      { item: 'Almond Milk', price: 3.49 },
      { item: 'Whole Wheat Bread', price: 4.2 },
    ],
    category: 'Groceries',
    confidence: 0.95,
    isFraudulent: false,
  ...
  },
  {
    ...
    date: '2024-07-18',
    totalAmount: 45.3,
    itemizedList: [{ item: 'Unleaded Fuel', price: 45.3 }],
    category: 'Travel',
    confidence: 0.89,
    isFraudulent: false,
    fraudulentDetails: 'No fraudulent activity detected.',
  },
  {
    ...
    date: '2024-07-15',
    totalAmount: 150.0,
    itemizedList: [{ item: 'Luxury Item', price: 150.0 }],
    category: 'Shopping',
    confidence: 0.92,
    isFraudulent: true,
